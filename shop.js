...
function shopItemIconHtml(it){
  if(it && it.type === 'piece-set'){
    if(it.isDefault || it.pieceSetId === 'default') return '⭕';
    const url = it.previewUrl || ('https://raw.githubusercontent.com/nokiapro/cotuong/refs/heads/main/quanco/'+(it.pieceSetId||'')+'/do_tuong.svg');
    return '<img class="gift-piece-preview" src="'+url+'" alt="" loading="lazy" referrerpolicy="no-referrer">';
  }
